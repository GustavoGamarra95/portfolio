    ...
    theme: {
        extend: {
            ...
            colors: {
                dark: "#1b1b1b",
                light: "#f5f5f5",
                primary: "#B63E96",      // rosa original
                primaryDark: "#58E6D9",  // azul verdoso
                transition: "#00ffd5",   // ✅ verde agua claro
                transitionDark: "#40e0d0", // ✅ verde agua oscuro
            },
            animation: {
            ...
            backgroundImage: {
                ...
                bgLightXl: 'linear-gradient(0deg, rgba(245, 245, 245, 1) 0%, rgba(245,245,245,0.85) 8%, rgba(245,245,245,0.7) 12.6%, rgba(245,245,245,0) 30%, rgba(245, 245, 245, 0) 50%, rgba(245,245,245,0) 82%, rgba(245,245,245,0.6) 90%, rgba(245, 245, 245, 2) 100%)',
            },
        },
        screens: {
            '2xl': {max: '1535px'},
